...
//    private val binding get()=mBinding!!
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_next.setOnClickListener {
            ...
            val captureView: Bitmap? = layout_imgMark?.getDrawingCache()
...
//            intent.putExtra("markedImg" , markedImg)
    ...
    private fun postApi(data:CreateEduImgData) {
        ...
        service.postCreateEduPhoto(data).enqueue(object : Callback<CreateEduImgResult> {
            override fun onResponse(call: Call<CreateEduImgResult>, response: Response<CreateEduImgResult>
            ) {
                var result = response.body()?.eduPhotoID
                Log.d("postApi result","SUCCESS!!!")
            }
